...
const addDetector = (key, detector2, loader2) => {
  ...
  log$1.error(`Detector with key ${key} added${loader2 ? " with loader" : ""}`);
};
...
const loader$n = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-be50ff6c.js");
...
const c4 = plugin$k;
const id$l = "flowchart";
const detector$l = (txt, config2) => {
  var _a, _b;
...
const loader$m = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-814bd308.js");
...
const flowchart = plugin$j;
const id$k = "flowchart-v2";
...
const loader$l = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-8a62640d.js");
...
const flowchartV2 = plugin$i;
const id$j = "er";
const detector$j = (txt) => {
  return /^\s*erDiagram/.test(txt);
};
const loader$k = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-f347d775.js");
...
const loader$j = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-8fb797bf.js");
...
const loader$i = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-21587375.js");
...
const gantt = plugin$f;
const id$g = "info";
const detector$g = (txt) => {
  return /^\s*info/.test(txt);
};
const loader$h = async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-794366da.js");
...
const loader$g = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-72acfe56.js");
...
const id$e = "quadrantChart";
const detector$e = (txt) => {
  return /^\s*quadrantChart/.test(txt);
};
const loader$f = async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-07f7e3c7.js");
...
const quadrantChart = plugin$e;
const id$d = "xychart";
const detector$d = (txt) => {
  return /^\s*xychart-beta/.test(txt);
};
const loader$e = async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-32bf6b61.js");
...
const xychart = plugin$d;
const id$c = "requirement";
const detector$c = (txt) => {
  return /^\s*requirement(Diagram)?/.test(txt);
};
const loader$d = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-84006a10.js");
...
const requirement = plugin$c;
const id$b = "sequence";
const detector$b = (txt) => {
  return /^\s*sequenceDiagram/.test(txt);
};
const loader$c = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-02e6a8bc.js");
...
const loader$b = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-0166bd23.js");
...
const classDiagram = plugin$a;
const id$9 = "classDiagram";
...
const loader$a = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-a5de3ffd.js");
...
const loader$9 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-600c13ba.js");
...
const state = plugin$8;
const id$7 = "stateDiagram";
...
const loader$8 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-a61e4480.js");
...
const stateV2 = plugin$7;
const id$6 = "journey";
const detector$6 = (txt) => {
  return /^\s*journey/.test(txt);
};
const loader$7 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-f6485f4c.js");
...
const loader$6 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-e3106bb9.js");
...
const flowchartElk = plugin$5;
const id$4 = "timeline";
const detector$4 = (txt) => {
  return /^\s*timeline/.test(txt);
};
const loader$5 = async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-f6f069d1.js");
...
const timeline = plugin$4;
const id$3 = "mindmap";
const detector$3 = (txt) => {
  return /^\s*mindmap/.test(txt);
};
const loader$4 = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-877533ea.js");
...
const mindmap = plugin$3;
const id$2 = "sankey";
const detector$2 = (txt) => {
  return /^\s*sankey-beta/.test(txt);
};
const loader$3 = async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-283a054f.js");
...
const sankey = plugin$2;
const id$1 = "d3fend";
const detector$1 = (txt, config2) => {
  return false;
};
const loader$2 = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-1c32b176.js");
...
const d3fend = plugin$1;
const id = "d3fend";
const detector = (txt, config2) => {
  if (
    // If diagram explicitly states flowchart-elk
    /^\s*d3fend/.test(txt)
  ) {
...
const loader$1 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-dbd30815.js");
...
export {
  ...
  ZERO_WIDTH_SPACE as _,
  getAccDescription as a,
  Set$2 as a$,
  lineBreakRegex as a0,
  defaultConfig as a1,
  commonDb as a2,
  isDark$1 as a3,
  lighten$1 as a4,
  ...
  copyObject as aB,
  keysIn as aC,
  getPrototype$1 as aD,
  cloneArrayBuffer as aE,
  cloneTypedArray as aF,
  getTag$1 as aG,
  nodeUtil$1 as aH,
  baseUnary as aI,
  copyArray as aJ,
  isBuffer$1 as aK,
  cloneBuffer as aL,
  initCloneObject as aM,
  Stack as aN,
  assignValue as aO,
  MapCache as aP,
  eq as aQ,
  Uint8Array$2 as aR,
  isTypedArray$1 as aS,
  isLength as aT,
  isIndex as aU,
  identity as aV,
  baseFor$1 as aW,
  root$1 as aX,
  baseRest as aY,
  isIterateeCall as aZ,
  baseAssignValue as a_,
  epsilon as aa,
  sqrt as ab,
  min as ac,
  abs$1 as ad,
