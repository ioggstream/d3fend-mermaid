import { O as H, P as at, x as lt, y as ct, s as ot, g as ht, b as ut, a as yt, z as ft, d as pt, c as et, l as it, Q as gt, N as dt, S as mt, k as _t } from "./mermaid-b08fd25b.js";
import { d as tt } from "./arc-38a121d0.js";
...
function St() {
  var e = bt, u = vt, A = null, p = z(0), g = z(H), E = z(0);
  function y(a) {
  ...
  return y.value = function(a) {
    return arguments.length ? (e = typeof a == "function" ? a : z(+a), y) : e;
    ...
    return arguments.length ? (p = typeof a == "function" ? a : z(+a), y) : p;
  }, y.endAngle = function(a) {
    return arguments.length ? (g = typeof a == "function" ? a : z(+a), y) : g;
...
var J = function() {
  var e = function(b, t, i, n) {
    ...
    parse: function(t) {
      var i = this, n = [0], r = [], c = [null], s = [], P = this.table, x = "", f = 0, V = 0, F = 2, M = 1, B = s.slice.call(arguments, 1), h = Object.create(this.lexer), N = { yy: {} };
      ...
      for (var k, L, S, Z, R = {}, j, D, X, W; ; ) {
        if (L = n[n.length - 1], this.defaultActions[L] ? S = this.defaultActions[L] : ((k === null || typeof k > "u") && (k = rt()), S = P[L] && P[L][k]), typeof S > "u" || !S.length || !S[0]) {
          ...
          W = [];
          for (j in P[L])
            this.terminals_[j] && j > F && W.push("'" + this.terminals_[j] + "'");
...
Expecting ` + W.join(", ") + ", got '" + (this.terminals_[k] || k) + "'" : q = "Parse error on line " + (f + 1) + ": Unexpected " + (k == M ? "end of input" : "'" + (this.terminals_[k] || k) + "'"), this.parseError(q, {
        ...
        switch (S[0]) {
          case 1:
            n.push(k), c.push(h.yytext), s.push(h.yylloc), n.push(S[1]), k = null, V = h.yyleng, x = h.yytext, f = h.yylineno, Q = h.yylloc;
            break;
          case 2:
            if (D = this.productions_[S[1]][1], R.$ = c[c.length - D], R._$ = {
              ...
              return Z;
            D && (n = n.slice(0, -1 * D * 2), c = c.slice(0, -1 * D), s = s.slice(0, -1 * D)), n.push(this.productions_[S[1]][0]), c.push(R.$), s.push(R._$), X = P[n[n.length - 2]][n[n.length - 1]], n.push(X);
            break;
          case 3:
            return !0;
        }
...
` + e);
  ...
  const s = _.selectAll(".legend").data(r.domain()).enter().append("g").attr("class", "legend").attr("transform", (f, V) => {
    const F = l + d, M = F * r.domain().length / 2, B = 12 * l, h = V * F - M;
  ...
  s.append("rect").attr("width", l).attr("height", l).style("fill", r).style("stroke", r), s.data(i).append("text").attr("x", l + d).attr("y", l - d).text((f) => {
    const { label: V, value: F } = f.data;
    return g.getShowData() ? `${V} [${F}]` : V;
  });
  const P = Math.max(
