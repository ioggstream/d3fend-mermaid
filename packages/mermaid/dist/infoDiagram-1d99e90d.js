import { l as Y, N as D, k as M } from "./mermaid-a4233606.js";
var O = function() {
  var a = function(u, t, e, n) {
    ...
    parse: function(t) {
      var e = this, n = [0], s = [], r = [null], i = [], d = this.table, $ = "", v = 0, L = 0, j = 2, T = 1, R = i.slice.call(arguments, 1), o = Object.create(this.lexer), p = { yy: {} };
      ...
      for (var l, g, h, w, _ = {}, b, c, F, S; ; ) {
        if (g = n[n.length - 1], this.defaultActions[g] ? h = this.defaultActions[g] : ((l === null || typeof l > "u") && (l = U()), h = d[g] && d[g][l]), typeof h > "u" || !h.length || !h[0]) {
          ...
          S = [];
          for (b in d[g])
            this.terminals_[b] && b > j && S.push("'" + this.terminals_[b] + "'");
