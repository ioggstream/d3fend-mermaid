import { c as rt, g as mt, s as _t, a as kt, b as xt, y as vt, x as bt, z as wt, f as St, a1 as Lt, j as G, r as Et } from "./mermaid-b08fd25b.js";
...
var tt = function() {
  var t = function(m, s, o, c) {
    ...
    parse: function(s) {
      var o = this, c = [0], _ = [], b = [null], d = [], x = this.table, E = "", L = 0, A = 0, N = 2, P = 1, z = d.slice.call(arguments, 1), S = Object.create(this.lexer), M = { yy: {} };
      for (var $ in this.yy)
...
const Ot = (t) => (t = St.sanitizeText(t, rt()), B[t] || (B[t] = new It(t), Q.push(B[t])), B[t]), $t = () => Q, zt = () => q, jt = () => ({
  ...
  arcTo: function(t, n, i, a, u) {
    ...
    if (this._x1 === null)
      ...
      if (!(Math.abs(c * m - s * o) > D) || !u)
        ...
        var b = i - y, d = a - p, x = m * m + s * s, E = b * b + d * d, L = Math.sqrt(x), A = Math.sqrt(_), N = u * Math.tan((et - Math.acos((x + _ - E) / (2 * L * A))) / 2), P = N / A, z = N / L;
        Math.abs(P - 1) > D && (this._ += "L" + (t + P * o) + "," + (n + P * c)), this._ += "A" + u + "," + u + ",0,0," + +(c * b > o * d) + "," + (this._x1 = t + z * m) + "," + (this._y1 = n + z * s);
      }
  },
...
function Jt(t) {
  var n = Kt, i = Zt, a = Xt, u = qt, y = null;
  function p() {
