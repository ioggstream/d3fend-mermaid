import { c as I, x as yt, y as ft, s as dt, g as pt, b as gt, a as mt, z as xt, j as W, k as kt } from "./mermaid-50853933.js";
import { d as _t, f as bt, a as vt, g as it } from "./svgDrawCommon-304ab778.js";
import { d as Q } from "./arc-1752de9f.js";
        ...
        switch (b[0]) {
          ...
          case 2:
            if (T = this.productions_[b[1]][1], A.$ = d[d.length - T], A._$ = {
              ...
              return O;
            T && (a = a.slice(0, -1 * T * 2), d = d.slice(0, -1 * T), l = l.slice(0, -1 * T)), a.push(this.productions_[b[1]][0]), d.push(A.$), l.push(A._$), K = w[a[a.length - 2]][a[a.length - 1]], a.push(K);
            break;
          case 3:
            return !0;
        }
